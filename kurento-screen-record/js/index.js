...
var args = getopts(location.search,
{
  default:
  {
    ...
    file_uri: 'file:///tmp/screen_recorder_demo.webm', // file to be stored in media server
...
function startRecording() {
  ...
  async function startCapture() {
    try {
      ...
      //screen_stream = stream.getTracks()[0];
      //audio_stream = stream.getTracks()[1];
      audio_stream = await navigator.mediaDevices.getUserMedia({audio:true,video:false});
      next();
      //dumpOptionsInfo();
    } catch (err) {
